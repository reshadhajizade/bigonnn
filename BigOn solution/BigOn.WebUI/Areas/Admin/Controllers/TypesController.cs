...
namespace BigOn.Domain.Areas.Admin.Controllers
{
    ...
    public class TypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,CreatedTime,DeletedTime")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,CreatedTime,DeletedTime")] ProductType productType)
        {
