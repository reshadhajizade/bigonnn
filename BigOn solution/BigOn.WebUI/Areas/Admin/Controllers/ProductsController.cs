...
namespace BigOn.WebUI.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(BigOnDbContext context,IMediator mediator)
        {
            _context = context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,StockKeepingUnit,Rate,Price,ShortDescription,Description,BrandId,CategoryId,Id,CreatedTime,DeletedTime")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
