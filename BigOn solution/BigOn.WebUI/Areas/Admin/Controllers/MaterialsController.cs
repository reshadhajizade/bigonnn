...
namespace BigOn.Domain.Areas.Admin.Controllers
{
    ...
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,CreatedTime,DeletedTime")] ProductMaterial productMaterial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,CreatedTime,DeletedTime")] ProductMaterial productMaterial)
        {
