...
namespace BigOn.Domain.Areas.Admin.Controllers
{
    ...
    public class FaqsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Question,Answer,DeletedDate,Id,CreatedTime,DeletedTime")] Faq faq)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Question,Answer,DeletedDate,Id,CreatedTime,DeletedTime")] Faq faq)
        {
            if (id != faq.Id)
            {
                return NotFound();
